      ...
      $mysqli = new mysqli('localhost', 'root', '', 'story_geek');
        ...
        Echo " 
              ...
              <div class='card' style='width: 15rem;' >
                <img id= 'imagem20' src='$img1' class='card-img-top' alt='...' onmouseenter='entrar100()' onmouseout='sair100()'>
                <div class='card-body'>
                  <p class='card-text'>$nome</p>
                  <p>R$$valor</p>
                  <center>
                    <div class='botão_comprar'>
                      <a href='Ver_produtor.php'><button style=' border-radius: 12px; border-radius: 12px; background-color: #30b258; width: 160px; height: 50px; color: white;'> Visualizar </button></a>
                      <a href='#'><button style=' border-radius: 12px; border-radius: 12px; background-color: #30b258; width: 160px; height: 50px; color: white; margin-top: 8px;'> Editar </button></a>
                    </div>
                  </center>
                </div>
              </div>";
